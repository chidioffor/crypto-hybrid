# CryptoHybrid Bank
Developed for Planet Sayari Bank and Siegfried Asset Management Limited UK
Its a comprehensive hybrid crypto-fiat banking web application that combines traditional banking with blockchain features to provide seamless management of fiat and crypto assets. Plus Investment banking (connected to Forex-Spider Trading Platform). Connection to Forex-Spider will be implimented in the future and not subject to this project scope at this stage.
...
#### For Windows:
```bash
git clone https://github.com/SAM-SAYARI-Hybrid-Crypto-Bank/SAM-SAYARI-Hybrid-Crypto-Bank.git
...
This project is licensed for Siegfried Asset Management Limited UK and Planet Sayari Bank.
